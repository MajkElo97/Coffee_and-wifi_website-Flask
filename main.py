...
class CafeForm(FlaskForm):
    ...
    wifi_strength = SelectField('Wifi Strength Rating', validators=[DataRequired()],
                                choices=['✘', '💪', '💪💪', '💪💪💪', '💪💪💪💪', '💪💪💪💪💪'])
    sockets = SelectField('Power sockets Avaibiliy', validators=[DataRequired()],
                          choices=['✘', '🔌️', '🔌🔌', '🔌🔌🔌', '🔌🔌🔌🔌', '🔌🔌🔌🔌🔌'])
...
def add_cafe():
    ...
    if form.validate_on_submit():
        print("True")
        data = (form.cafe.data, form.cafe_location.data, form.opening_time.data, form.closing_time.data,
                form.coffee_rating.data, form.wifi_strength.data, form.sockets.data)
        data = ",".join(data)
        print(data)
        # Exercise:
